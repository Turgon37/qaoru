...
![AppVersion: 0.12.4-slim](https://img.shields.io/badge/AppVersion-0.12.4-slim-informational?style=flat-square)
...
```bash
helm install open-terminal oci://ghcr.io/qaoru/helm-charts/open-terminal --version 0.2.3
```

Or with a local `values.yaml`:

```bash
helm install open-terminal oci://ghcr.io/qaoru/helm-charts/open-terminal --version 0.2.3 -f values.yaml
```
